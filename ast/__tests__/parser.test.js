...
INT z IS x ADD y!
  ...
  unary: [
    String.raw`INT x IS -10!
      `,
    new Program([new Declaration('INT', 'x', new UnaryExp('-', new Literal('INT', 10)))]),
  ],
  ...
  for: [
    ...
    new Program([
      new ForStatement(
        'INT',
        new Identifier('x'),
        new RangeExp('(', new Literal('INT', 0), new Literal('INT', 10), null, ')'),
        [
          new PrintStatement([
            new BinaryExp(
              new Identifier('x'),
  ...
  tuple: [
    ...
    new Program([
      new Declaration(
        ...
        'd',
        new TupleExp([new Literal('INT', 1), new Literal('FLT', 2.5), new Literal('STR', 'hello')])
      ),
    ]),
  ],
  simpleSuite: [
        ...
        new ReturnStatement(
          new BinaryExp(
            new CallExp(new Identifier('fibonacci'), [
              new Arg(new BinaryExp(new Identifier('num'), 'SUB', new Literal('INT', 2))),
            ]),
            'ADD',
            new CallExp(new Identifier('fibonacci'), [
              new Arg(new BinaryExp(new Identifier('num'), 'SUB', new Literal('INT', 1))),
            ])
          )
        ),
      ]),
